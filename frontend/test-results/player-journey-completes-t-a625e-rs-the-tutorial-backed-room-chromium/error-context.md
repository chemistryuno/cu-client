...
- Name: player-journey.spec.ts >> completes the tutorial flow and enters the tutorial-backed room
- Location: tests\e2e\player-journey.spec.ts:21:1
...
Call log:
  - waiting for getByTestId('lobby-tutorial-button')
    - locator resolved to <button data-testid="lobby-tutorial-button" class="px-8 py-4 bg-slate-800 dark:bg-white/10 hover:bg-slate-700 dark:hover:bg-white/20 text-white rounded-2xl text-xs font-black uppercase tracking-[0.2em] shadow-lg transition-all hover:scale-105 active:scale-95 flex items-center gap-3 border border-white/5">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div data-v-d1d42e10="" data-v-7a7a37b1="" class="fixed inset-0 bg-slate-900/40 dark:bg-black/70 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">…</div> intercepts pointer events
...
- generic [ref=e3]:
      ...
      - generic [ref=e8]:
        ...
        - generic [ref=e14]:
          - generic [ref=e15] [cursor=pointer]:
            - img [ref=e17]
            - generic [ref=e19]:
              - generic [ref=e20]: JourneyTutorial
          ...
          - generic [ref=e59]:
            - generic [ref=e60]:
              ...
              - generic [ref=e62]:
                - img [ref=e64]
                - generic [ref=e66]:
                  - paragraph [ref=e67]: JourneyTutorial
  ...
  - generic [ref=e91]:
    - generic [ref=e92]:
      - img [ref=e94]
      - heading "System Error" [level=3] [ref=e96]
    - paragraph [ref=e98]: Not logged in
    - button "确定" [ref=e100]
```
...
```ts
  ...
  2   | 
  3   | export const LOCAL_STORAGE_KEYS = {
  4   |   tutorialDone: 'chemistry-uno-lobby-tutorial-completed',
  5   |   tutorialSkipped: 'chemistry-uno-lobby-tutorial-skipped',
  6   |   tutorialMode: 'chemistry-uno-tutorial-mode',
  7   |   offlineState: 'chemistry-uno-offline-state-v2',
  8   | } as const
  9   | 
  10  | export const resetRuntimeState = async (page: Page) => {
