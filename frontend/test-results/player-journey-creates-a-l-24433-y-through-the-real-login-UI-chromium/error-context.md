...
- Name: player-journey.spec.ts >> creates a local identity through the real login UI
- Location: tests\e2e\player-journey.spec.ts:19:1
  ...
  - generic [ref=e20]:
    ...
    - generic [ref=e30]:
      ...
      - generic [ref=e34]:
        ...
        - paragraph [ref=e36]: JourneyLogin
    ...
    - generic [ref=e38]:
      - generic [ref=e39]:
        ...
        - generic [ref=e43]:
          - generic:
            - img
          - textbox "输入你的玩家昵称 / Enter your player nickname" [ref=e44]: JourneyLogin
      - generic [ref=e45]:
      ...
      - button "初始化中... / Initializing..." [disabled] [ref=e134]:
        - img [ref=e135]
        - text: 初始化中... / Initializing...
```
