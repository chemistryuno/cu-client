...
Call log:
  - waiting for getByRole('button', { name: /skip tutorial|跳过引导/i })
    - locator resolved to <button data-v-7db6f6f1="" class="min-h-[44px] px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-500 dark:text-slate-400 font-bold text-sm transition-colors border border-slate-200 dark:border-slate-700"> 跳过引导 </button>
