...
- [x] 3.2 Add a tutorial journey test that completes the tutorial flow and reaches the tutorial-backed room through player clicks
- [x] 3.3 Add a real match journey test that starts or joins a playable non-tutorial match and validates core in-room controls
- [x] 3.4 Add gameplay interaction assertions for representative in-room actions such as ready, start, draw, play, or hint-related operations

## 4. Related feature regression tests

- [x] 4.1 Add regression tests for profile or settings-related player flows
- [x] 4.2 Add regression tests for history or replay-related flows
- [x] 4.3 Add regression tests for reaction and substance-related pages or views
...
- [x] 5.3 Verify the suite against the local runtime and capture any required test environment notes
